...
@app.route('/image')
def index():
    return render_template('steg-img/index.html')

# Route pour la page de l'encodage (cacher un message)
@app.route('/encode')
def encode_page():
    return render_template('steg-img/encode.html')

# Route pour la page du décodage (extraire un message)
@app.route('/decode')
def decode_page():
    return render_template('steg-img/decode.html')
...
def decode():
    try:
        ...
        return render_template("steg-img/decode.html", message=message)
